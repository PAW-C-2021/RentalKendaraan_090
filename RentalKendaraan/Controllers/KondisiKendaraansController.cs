...
namespace RentalKendaraan.Controllers
{
    public class KondisiKendaraansController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdKondisi,NamaKondis")] KondisiKendaraan kondisiKendaraan)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdKondisi,NamaKondis")] KondisiKendaraan kondisiKendaraan)
        {
