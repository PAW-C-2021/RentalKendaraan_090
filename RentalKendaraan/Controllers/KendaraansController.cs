...
namespace RentalKendaraan.Controllers
{
    public class KendaraansController : Controller
    {
        ...
        {
            var rentKendaraanContext = _context.Kendaraans.Include(k => k.IdKendaraanNavigation);
        ...
        {
            ViewData["IdKendaraan"] = new SelectList(_context.JenisKendaraans, "IdJenisKendaraan", "IdJenisKendaraan");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("IdKendaraan,NamaKendaraan,NoPolisi,NoStnk,IdJenisKendaraan,Ketersediaan")] Kendaraan kendaraan)
        {
            ...
            ViewData["IdKendaraan"] = new SelectList(_context.JenisKendaraans, "IdJenisKendaraan", "IdJenisKendaraan", kendaraan.IdKendaraan);
            return View(kendaraan);
        }
